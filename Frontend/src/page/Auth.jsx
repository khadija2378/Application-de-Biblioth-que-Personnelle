  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="relative w-full max-w-4xl h-[480px] bg-white rounded-xl shadow-xl overflow-hidden perspective-1200">
        ...
        <div
          className={`absolute top-0 left-0 h-1/2 md:h-full w-full md:w-1/2 transition-transform duration-700 preserve-3d
          ${flip ? "translate-x-full rotate-y-180" : ""}`}
        >
          <div className="absolute inset-0 bg-linear-to-br from-[#800020] to-[#4B0016] text-white flex flex-col justify-center items-center space-y-9 backface-hidden">
            <LogIn size={60}/>
          ...
          <div className="absolute inset-0 bg-linear-to-br from-[#800020] to-[#4B0016] text-white flex flex-col justify-center items-center space-y-9 backface-hidden rotate-y-180">
